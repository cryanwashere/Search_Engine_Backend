...
class ClassificationStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ClassifyImage = channel.unary_unary(
                ...
                request_serializer=classification__pb2.ImageClassificationRequest.SerializeToString,
...
def add_ClassificationServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ClassifyImage': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=classification__pb2.ImageClassificationRequest.FromString,
    ...
    server.add_registered_method_handlers('Classification', rpc_method_handlers)
...
class Classification(object):
    ...
    def ClassifyImage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Classification/ClassifyImage',
            classification__pb2.ImageClassificationRequest.SerializeToString,
